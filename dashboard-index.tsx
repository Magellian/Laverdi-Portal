    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container-max py-12">
          ...
          {/* OpenClaw Access Button */}
          {user && (
            <div className="mb-12">
              <OpenClawAccessButton
                userId={user.id}
                tier={user.tier}
                modelId={user.model_id || 'anthropic-claude-haiku-4.5'}
              />
            </div>
          )}
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-12 border-l-4 border-blue-500">
            ...
            {instance?.status === 'provisioning' && (
              <p className="text-sm text-gray-500 mt-4">
                Your dedicated OpenClaw instance is currently being configured. You will receive an email when it is ready. This usually takes 2-4 minutes.
              </p>
            )}
            
            {instance?.status === 'ready' && instance?.ip_address && (
              <div className="mt-4 pt-4 border-t border-gray-100">
                ...
                <div className="flex gap-4">
                  <a href={`http://${instance.ip_address}:${instance.port || 8700}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1">
                    Open Web Interface →
                  </a>
                </div>
              </div>
