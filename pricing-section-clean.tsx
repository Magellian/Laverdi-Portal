            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-700">
                  Tokens are the building blocks of AI responses. On average:<br/>
                  • Short message: 50-200 tokens<br/>
                  • Paragraph: 200-500 tokens<br/>
                  • Code snippet: 100-300 tokens<br/>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-700">
                  <strong>Trial:</strong> 1M ≈ 33K/day<br/>
                  <strong>Starter:</strong> 10M ≈ 333K/day<br/>
                  <strong>Professional:</strong> 50M ≈ 1.67M/day<br/>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-700">
                  Exceeding monthly limits:<br/>
                  • Trial: Upgrade required (no overage)<br/>
                  • Starter: $0.00275 per 1K tokens<br/>
                  • Professional: $0.01 per 1K tokens<br/>
