const RELEASES_URL = 'https://github.com/Magellian/laverdi-companion/releases'
          ...
          >
            ...
            {platform.available ? (
              <a
                ...
                className="flex items-center justify-center gap-2 rounded-lg bg-white text-black text-sm font-medium px-4 py-2.5 hover:bg-zinc-200 transition-colors"
              >
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
                Download{platform.name === 'Windows' ? ' for Windows' : ''}
              </a>
            ) : (
              <button
                disabled
